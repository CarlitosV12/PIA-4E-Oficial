...
def pasww():
    ...
    logging.info("Pidiendo longitud de contraseña")
    # Validamos que el dato ingresado sea un entero
    while True:
        try:
            
            number= int(input("Ingrese un la cantidad de carácteres para la contraseña (un número): "))
    ...
    logging.info(f"Longitud de contraseña : {long}")
   ...
   #
    ...
    filename = "PassGen"
    total_body = ""
    total_body += "Tu contraseña es:"+ password
    print("Tarea que se ejecutó: Generar contraseña\n")
